...
const autolog = {
    ...
    warn(text, time) {
        this.log('warn', text, time);
    },
    error(text, time) {
        this.log('error', text, time);
    },
    info(text, time) {
        this.log('info', text, time);
    },
    success(text, time) {
        this.log('success', text, time);
    },
};
const clicklog = {
...
function updateStyle() {
    let styleEl = document.querySelector("#autolog-style");
    if (!styleEl) {
        styleEl = document.createElement("style");
        styleEl.id = "autolog-style";
